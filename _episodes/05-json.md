...
# Instead, please edit 05-json.md in _episodes_rmd/
...
$ A08_ward                       <chr> "ward2", "ward2", "ward2", "ward2", "w…
$ E01_water_use                  <chr> "no", "yes", "no", "no", "no", "no", "…
...
$ instanceID                     <chr> "uuid:ec241f2c-0609-46ed-b5e8-fe575f6c…
...
$ C02_respondent_wall_type       <chr> "muddaub", "muddaub", "burntbricks", "…
$ C05_buildings_in_compound      <int> 1, 1, 1, 1, 1, 1, 1, 2, 2, 1, 2, 2, 1,…
$ `_remitters`                   <list> [<data.frame[0 x 0]>, <data.frame[0 x…
$ E18_months_no_water            <list> [NULL, <"Aug", "Sept">, NULL, NULL, N…
$ F07_use_income                 <chr> NA, "AlimentaÃ§Ã£o e pagamento de educ…
...
$ A05_end                        <chr> "2017-04-02T17:29:08.000Z", "2017-04-0…
$ C04_window_type                <chr> "no", "no", "yes", "no", "no", "no", "…
...
$ C03_respondent_floor_type      <chr> "earth", "earth", "cement", "earth", "…
$ E_yes_group                    <list> [<data.frame[0 x 0]>, <data.frame[3 x…
$ A01_interview_date             <chr> "2016-11-17", "2016-11-17", "2016-11-1…
$ B11_remittance_money           <chr> "no", "no", "no", "no", "no", "no", "n…
$ A04_start                      <chr> "2017-03-23T09:49:57.000Z", "2017-04-0…
...
$ F13_du_look_aftr_cows          <chr> "no", "no", "no", "no", "no", "no", "n…
$ E26_affect_conflicts           <chr> NA, "once", NA, NA, NA, NA, "never", "…
$ F14_items_owned                <list> [<"bicycle", "television", "solar_pan…
$ F06_crops_contr                <chr> NA, "more_half", NA, NA, NA, NA, "more…
...
$ E_no_group_count               <chr> "2", NA, "1", "3", "2", "1", NA, NA, N…
$ E22_res_change                 <list> [NULL, NULL, NULL, NULL, NULL, NULL, …
$ E24_resp_assoc                 <chr> NA, "no", NA, NA, NA, NA, NA, "yes", N…
...
$ `gps:Accuracy`                 <dbl> 14, 19, 13, 5, 10, 12, 11, 9, 11, 14, …
$ E20_exper_other                <chr> NA, "yes", NA, NA, NA, NA, "yes", "yes…
$ A09_village                    <chr> "village2", "village2", "village2", "v…
$ C01_respondent_roof_type       <chr> "grass", "grass", "mabatisloping", "ma…
...
$ E19_period_use                 <dbl> NA, 2, NA, NA, NA, NA, 10, 10, 6, 22, …
$ E25_fees_water                 <chr> NA, "no", NA, NA, NA, NA, "no", "no", …
$ C07_other_buildings            <chr> "no", "no", "no", "no", "no", "no", "y…
$ observation                    <chr> "None", "Estes primeiros inquÃ©ritos n…
$ `_note`                        <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA…
$ A12_agr_assoc                  <chr> "no", "yes", "no", "no", "no", "no", "…
$ G03_no_food_mitigation         <list> [<"na", "rely_less_food", "reduce_mea…
$ F05_money_source_other         <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA…
$ `gps:Latitude`                 <dbl> -19.11226, -19.11248, -19.11211, -19.1…
$ E_no_group                     <list> [<data.frame[2 x 6]>, <data.frame[0 x…
$ F14_items_owned_other          <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA…
$ F08_emply_lab                  <chr> "no", "yes", "no", "no", "no", "no", "…
$ `_members_count`               <chr> "3", "7", "10", "7", "7", "3", "6", "1…
~~~
{: .output}
